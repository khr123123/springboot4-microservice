...
public class InventoryController {
    ...
    public ResponseEntity<Inventory> getInventoryByProductId(@PathVariable Long productId) {
        return inventoryService.getInventoryByProductId(productId).map(ResponseEntity::ok)
    ...
    public ResponseEntity<Boolean> checkInventory(@PathVariable Long productId, @PathVariable Integer quantity) {
    ...
    public ResponseEntity<Boolean> reduceInventory(@PathVariable Long productId, @PathVariable Integer quantity) {
        return ResponseEntity.ok(inventoryService.reduceInventory(productId, quantity));
    }
    ...
    public ResponseEntity<Void> increaseInventory(@PathVariable Long productId, @PathVariable Integer quantity) {
